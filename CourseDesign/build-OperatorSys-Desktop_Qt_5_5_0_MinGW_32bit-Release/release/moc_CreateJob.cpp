...
#include "../../OperatorSys/CreateJob.h"
...
const QMetaObject CreateJob::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CreateJob.data,
      qt_meta_data_CreateJob,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CreateJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CreateJob.stringdata0))
        return static_cast<void*>(const_cast< CreateJob*>(this));
