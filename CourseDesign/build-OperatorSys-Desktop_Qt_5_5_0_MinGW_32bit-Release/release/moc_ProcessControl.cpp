...
#include "../../OperatorSys/ProcessControl.h"
...
const QMetaObject ProcessControl::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ProcessControl.data,
      qt_meta_data_ProcessControl,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ProcessControl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProcessControl.stringdata0))
        return static_cast<void*>(const_cast< ProcessControl*>(this));
